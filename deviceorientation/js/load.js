var game = new Phaser.Game(750, 1334, Phaser.CANVAS, "zarva", null, true);
// var game = new Phaser.Game(750, 1334, Phaser.CANVAS, "zarva");
var Load = function () {};
Load.prototype = {
    ...
    startLoad: function () {
           this.load.image('imageKey', '../img/yun.png');
            this.load.image('space', '../img/GAMEBG.png');
    ...
    tips: function () {
        // this.bg = this.add.sprite(0, 0, 'space');
        ...
        // this.title = this.add.text(this.world.centerX, this.setScale(80), '小提示', {
        //     font: this.setScale(50) + "px myFont",
        //     fill: '#fff'
        // });
        ...
        //     var remindImg = game.add.image(0, 0, 'remind');
        //     remindImg.width = game.world.width;
        //     remindImg.height = game.world.height;
 ...
 function preload() {
     ...
     game.load.image('imageKey', '../img/yun.png');
    //  game.load.image('space', '../img/GAMEBG.png');
 }

 function create() {
     //参数：x坐标，y坐标，图片关键字  
    //  var bg = game.add.tileSprite(0, 0, 750, 1334, 'space');
