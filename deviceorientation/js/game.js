...
MyGame.prototype = {
    ...
    iniGame: function () {
        ...
        this.atlasY = this.world.height - this.setScale(5)
        for (var i = 0; i < 10; i++) {
            this.setAtlas(this.setScale(5 + 150 * i), this.atlasY, 'atlas', 'yun2', 0);
        };
        this.addAtlas(25);
        ...
        this.play.animations.add('go', Phaser.Animation.generateFrameNames('but',1, ''), 15, true);
        this.play.play('go');
        ...
        //得分
        this.text = this.add.text(this.world.width - this.setScale(200), this.setScale(20), '得分：0', {
            font: this.setScale(30) + "px myFont",
            fill: '#6c6f3a'
        });
    ...
    setAtlas: function (x, y, key, frame, type) {
        ...
        atlas.types = type;
        atlas.spring = this.atlasKey[0].velocity
    ...
    addAtlas: function (num) {
        for (var i = 0; i < num; i++) {
            ...
            this.setAtlas(x, this.atlasY, 'atlas', this.atlasMap[this.atlasIndex].key, this.atlasMap[this.atlasIndex].key);
    ...
    gameEnd: function (type) {
        ...
        this.overTitle = this.add.text(this.world.centerX, this.setScale(200), oTitle, {
            font: this.setScale(50) + "px myFont",
            fill: '#fff'
        });
        this.overTitle.anchor.set(0.5);

        this.overScore = this.add.text(this.world.centerX, this.setScale(400), this.score, {
...
//         //黑洞吸人动画
//         this.add.tween(this.play.scale).to({
//             x: 0,
//             y: 0
//         }, 1000, "Linear", true);
//         this.add.tween(this.play).to({
//             x: this.hole.x,
//             y: this.hole.y
//         }, 1000, "Linear", true).onComplete.addOnce(function () {
//             console.log('被黑洞吸了')
//             this.play.kill();
//         }, this);
